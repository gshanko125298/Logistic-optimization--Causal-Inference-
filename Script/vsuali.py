...
def classification_metrics(
    ...
    Args:
        y (numpy.array): target
        p (numpy.array): prediction
        w (numpy.array, optional): a fullfilled vector (1 or True: fullfilled, 0 or False: control). If given, log
            metrics for the unfullfilled and control group separately
